...
train_batches = datagen.flow_from_directory('crop_images/train_images/', batch_size=batch_size, class_mode = 'categorical', target_size=(224, 224), shuffle=True)
test_batches = datagen_test.flow_from_directory('crop_images/test_images/', batch_size=batch_size, class_mode = 'categorical', target_size=(224, 224))
...
model.save_weights('weights_crop.h5')


import json
with open('history_crop.json', 'w') as f:
